...
| 34 | **太简单、没压力** / **打 Boss 冷场、拖太久** | 全局品质审计（`docs/AUDIT.md`）；同类游戏「后期无敌、没挑战」「Boss 战拖沓」的抱怨 | 危险 1–5 加入攻城（更多敌人直奔圣火），加上地图难度系数：危险 3 从 90–100% 降到 48–80%。终局决战：灭火者直扑圣火，小怪有上限，拖久了力竭，最长约 7 分钟（原来最长 26 分钟） | ✅ |
| 35 | **找不到怪 / 等怪** | 审计：最长击杀断档 11–32 秒 | 心流保护：身边 1.5 秒没怪，下一群直接刷到身边；远处随机刷怪从 15% 降到 5%。最长断档降到 9–15 秒 | ✅ |
| 36 | **不能改键、没有画质选项、色弱看不清预警** | Steam 差评常见；审计 | 设置加入画质、镜头远近、色弱辅助（预警换成蓝 / 黄）、切出窗口暂停、按键设置（14 个操作，界面键帽跟着改键走） | ✅ |
| 37 | **自己被房子挡住** | 审计截图 | 圣火周围 96 像素内不许造塔；英雄被房屋、树、建筑挡住时画出透过去的轮廓标记 | ✅ |
